        ...
        <div class="container mx-auto flex items-center flex-wrap pt-4 pb-12">
            ...
            <nav id="store" class="w-full z-30 top-0 px-6 py-1">
                <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-2 py-3">
                    ...
                    <div class="uppercase tracking-wide no-underline hover:no-underline font-bold text-gray-800 text-xl " href="#">
				Store
			</div>

                    <form action="index.php" method="get" class="flex items-center" id="store-nav-content">

                        <input type="text" class="p-4 bg-gray-200 rounded-xl" name = "item" placeholder="Search for items"/>

                        <button type="submit" name="search_btn" class="pl-3 inline-block no-underline hover:text-black" href="#">
